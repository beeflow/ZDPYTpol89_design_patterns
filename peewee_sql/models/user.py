...
class User(BaseModel):
    ...
    first_name = ForeignKeyField(FirstName, null=False, column_name="user_first_name_id")
    last_name = ForeignKeyField(LastName, null=False, column_name="user_last_name_id")
